...
const EditRecipeCard: React.FC<CardProps> = ({ id, image, title, time, servings, difficulty }) => {
  ...
  const handleDelete = async () => {
    const proceed = window.confirm('apakah anda yakin ingin menghapus resep ini?');
    if (!proceed) {
      return;
    }
